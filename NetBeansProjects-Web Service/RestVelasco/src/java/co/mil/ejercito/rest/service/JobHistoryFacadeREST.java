...
import co.mil.ejercito.rest.JobHistory;
import co.mil.ejercito.rest.JobHistoryPK;
 ...
 */
@Stateless
@Path("co.mil.ejercito.rest.jobhistory")
public class JobHistoryFacadeREST extends AbstractFacade<JobHistory> {
    ...
    private JobHistoryPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        co.mil.ejercito.rest.JobHistoryPK key = new co.mil.ejercito.rest.JobHistoryPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        co.mil.ejercito.rest.JobHistoryPK key = getPrimaryKey(id);
