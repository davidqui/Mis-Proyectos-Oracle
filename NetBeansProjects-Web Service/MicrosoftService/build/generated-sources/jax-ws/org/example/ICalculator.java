...
public interface ICalculator {
    ...
    @WebResult(name = "result", targetNamespace = "http://Example.org")
    @RequestWrapper(localName = "Subtract", targetNamespace = "http://Example.org", className = "org.example.Subtract")
    @ResponseWrapper(localName = "SubtractResponse", targetNamespace = "http://Example.org", className = "org.example.SubtractResponse")
