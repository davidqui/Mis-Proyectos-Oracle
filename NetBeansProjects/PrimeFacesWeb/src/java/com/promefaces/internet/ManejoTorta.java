...
@ManagedBean
public class ManejoTorta implements Serializable {
    ...
    private void createDonutModels() {
        ...
        donutModel1.setTitle("Dona Comprimida Hecha por David Quijano");
        donutModel1.setLegendPosition("w");
         
        donutModel2 = initDonutModel();
        donutModel2.setTitle("Torta separada");
    ...
    private DonutChartModel initDonutModel() {
        ...
        circle4.put("Brand 1", 100);
        circle4.put("Brand 2", 25);
        circle4.put("Brand 3", 42);
        circle4.put("Brand 4", 210);
